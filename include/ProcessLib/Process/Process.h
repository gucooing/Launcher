...
namespace libTools
{
	...
	public:
		...
		//
		static BOOL CreateProc(_In_ CONST std::wstring& wsProcPath, _In_ BOOL IsSupended, _In_ CONST std::wstring wsSpecifyWorkDirectory,  _Out_opt_ PROCESS_INFORMATION* pRetProcInfo = nullptr);
	private:
