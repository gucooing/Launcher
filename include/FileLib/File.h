...
namespace libTools
{
	...
	public:
		...
		// Worker(FileName|DirectoryName, IsDirectory)
		static void ForeachDirectory(_In_ CONST std::wstring& wsPath, _In_ std::function<BOOL(CONST std::wstring&, BOOL)> Worker);
	};
