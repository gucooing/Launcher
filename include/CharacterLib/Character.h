...
namespace libTools
{
	...
	public:
		...
		static BOOL SplitFormatText(_In_ CONST std::wstring& wsText, _In_ CONST std::wstring& wsFormatText, _Out_opt_ std::vector<std::wstring>& VecResult, _In_ BOOL IsAllowEmpty = FALSE);
